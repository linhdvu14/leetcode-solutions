...
# line. We are given an array widths, an array where widths[0] is the width 
# of 'a', widths[1] is the width of 'b', ..., and widths[25] is the width of 'z'.
...
# Considerations: 
# - empty string -> count 0, non-empty but short string --> count 1
