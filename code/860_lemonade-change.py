...
# ----------------------------------------------
# Ideas: Use 5 to pay 10; use 10 then 5 to pay 20
...
class Solution:
    def lemonadeChange(self, bills):
        ...
        # # If customers come in any order:
        # n5, n10, n20 = bills.count(5), bills.count(10), bills.count(20)
        # n5 -= n10 + n20  # need one 5 to change for each 10 and each 20
        # return n5 >= 0 and n10 + n5 // 2 >= n20
